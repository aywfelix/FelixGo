...
func SetRedisScript() {
	DbRedis.SetScript(REDIS_SCRIPT_GET, redis_script_get, 1)
	DbRedis.SetScript(REDIS_SCRIPT_HGET, redis_script_hget, 1)
	DbRedis.SetScript(REDIS_SCRIPT_SET, redis_script_set, 1)
	DbRedis.SetScript(REDIS_SCRIPT_HSET, redis_script_hset, 1)
	DbRedis.SetScript(REDIS_SCRIPT_UNLOCK, redis_script_unlock, 1)
	DbRedis.SetScript(REDIS_SCRIPT_HUNLOCK, redis_script_hunlock, 1)
	DbRedis.SetScript(REDIS_SCRIPT_DEL, redis_script_del, 1)
	DbRedis.SetScript(REDIS_SCRIPT_HDEL, redis_script_hdel, 1)
	DbRedis.SetScript(REDIS_SCRIPT_PUSH, redis_script_push, 1)
	DbRedis.SetScript(REDIS_SCRIPT_POP, redis_script_pop, 1)
	DbRedis.SetScript(REDIS_SCRIPT_INCRBY, redis_script_incrby, 1)
	DbRedis.SetScript(REDIS_SCRIPT_GLOCK, redis_script_glock, 1)
	DbRedis.SetScript(REDIS_SCRIPT_GUNLOCK, redis_script_gunlock, 1)
}
